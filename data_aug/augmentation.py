...
def wdba(x, y, batch_size=6, slope_constraint="symmetric", use_window=True, verbose=0):
...
def discriminative_guided_warp(x, y, batch_size=6, slope_constraint="symmetric", use_window=True, dtw_type="normal", use_variable_slice=True, verbose=0):
    # use verbose = -1 to turn off warnings
    # slope_constraint is for DTW. "symmetric" or "asymmetric"
    # dtw_type is for shapeDTW or DTW. "normal" or "shape"
...
def discriminative_guided_warp_shape(x, y, batch_size=6, slope_constraint="symmetric", use_window=True):
    return discriminative_guided_warp(x, y, batch_size, slope_constraint, use_window, dtw_type="shape")
